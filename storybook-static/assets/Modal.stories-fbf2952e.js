...
}`,...(B=(S=r.parameters)==null?void 0:S.docs)==null?void 0:B.source}}};var q,w,E;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`args => {
  const [isOpen, setIsOpen] = useState<boolean>(false);
  const handleOpenModal = () => setIsOpen(!isOpen);
  return <div style={{
    width: '100%',
...
}`,...(E=(w=l.parameters)==null?void 0:w.docs)==null?void 0:E.source}}};var T,L,W;d.parameters={...d.parameters,docs:{...(T=d.parameters)==null?void 0:T.docs,source:{originalSource:`args => {
  const [isOpen, setIsOpen] = useState<boolean>(false);
  const handleOpenModal = () => setIsOpen(!isOpen);
  return <div style={{
    width: '100%',
...
//# sourceMappingURL=Modal.stories-fbf2952e.js.map
